...
| 페이지 | 주소 | 내용 |
|---|---|---|
| 썸네일 생성 | `http://localhost:8501/` | 업로드, 옵션(샘플 수·크기·크롭·형식), 영상 정보, 썸네일 그리드 |
...
파일은 앱이 도는 동안만 존재합니다. 결과를 보관하려면 앱이 도는 동안 `output/thumbnails/`에서 복사해 두세요. 두 폴더는 `.gitignore`에 포함되어 있습니다.
